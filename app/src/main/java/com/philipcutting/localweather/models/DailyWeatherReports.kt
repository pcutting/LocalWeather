...
import com.philipcutting.localweather.networking.*
...
data class DailyWeatherReports(
        ...
        private var dailyWeatherList: List<DailyWeatherOneCallItem>?
) {

    fun fiveDayForcast() =  dailyWeatherList.subList(0,4)
